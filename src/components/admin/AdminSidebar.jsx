    ...
    <>
      {phoneActive && (
        <button
          ...
          style={{ marginTop: '50px' }} // Adjusted margin here
        >
          <HiMenuAlt4 />
        </button>
      )}
...
const DivTwo = ({ location }) => (
  <div>
    ...
    <ul>
      <Li
        url="/super-admin/chart/bar"
        text="Bar"
        Icon={FaChartBar}
        location={location}
      />
      <Li
        url="/super-admin/chart/pie"
        text="Pie"
        Icon={FaChartPie}
        location={location}
      />
      <Li
        url="/super-admin/chart/line"
        text="Line"
        Icon={FaChartLine}
        location={location}
      />
...
const DivThree = ({ location }) => (
  <div>
    ...
    <ul>
      <Li
        url="/super-admin/app/stopwatch"
        text="Stopwatch"
        Icon={FaStopwatch}
        location={location}
      />
      <Li
        url="/super-admin/app/toss"
        text="Toss"
        Icon={FaGamepad}
        location={location}
      />
